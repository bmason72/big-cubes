...
MEMO_DATARATE_TABLE: Dict[str, Dict[str, Dict[str, Dict[str, RefValue]]]] = {
    "M1": {
        ...
        # "both" = sum(12m, 7m) per-stat under the concurrent-operation
        # aggregation rule.  Derived from memo 12m+7m cells; memo printed a
        # pooled-population value that did not reflect concurrent load.
        "both": {"median": {"datarate": _r(0.025, "GB/s", "sum of " + _MEMO_DR_FILE + " M1 median 12m+7m",
                                           rel_tol=0.1),
                            "nchan_agg": _r(40_936, "", "sum of " + _MEMO_DR_FILE + " M1 channels median 12m+7m")},
                 "twa":    {"datarate": _r(0.060, "GB/s", "sum of " + _MEMO_DR_FILE + " M1 TWA 12m+7m"),
                            "nchan_agg": _r(92_098, "", "sum of " + _MEMO_DR_FILE + " M1 channels TWA 12m+7m")},
                 "max":    {"datarate": _r(0.225, "GB/s", "sum of " + _MEMO_DR_FILE + " M1 max 12m+7m"),
                            "nchan_agg": _r(296_296, "", "sum of " + _MEMO_DR_FILE + " M1 channels max 12m+7m")}},
    },
    "M4": {
        ...
        "both": {"median": {"datarate": _r(0.052, "GB/s", "sum of " + _MEMO_DR_FILE + " M4 median 12m+7m"),
                            "nchan_agg": _r(40_906, "", "sum of " + _MEMO_DR_FILE + " M4 channels median 12m+7m")},
                 "twa":    {"datarate": _r(0.201, "GB/s", "sum of " + _MEMO_DR_FILE + " M4 TWA 12m+7m"),
                            "nchan_agg": _r(164_965, "", "sum of " + _MEMO_DR_FILE + " M4 channels TWA 12m+7m")},
                 "max":    {"datarate": _r(1.767, "GB/s", "sum of " + _MEMO_DR_FILE + " M4 max 12m+7m"),
                            "nchan_agg": _r(1_185_184, "", "sum of " + _MEMO_DR_FILE + " M4 channels max 12m+7m")}},
    },
    "M5": {
        ...
        "both": {"median": {"datarate": _r(0.123, "GB/s", "sum of " + _MEMO_DR_FILE + " M5 median 12m+7m"),
                            "nchan_agg": _r(90_778, "", "sum of " + _MEMO_DR_FILE + " M5 channels median 12m+7m")},
                 "twa":    {"datarate": _r(0.488, "GB/s", "sum of " + _MEMO_DR_FILE + " M5 TWA 12m+7m"),
                            "nchan_agg": _r(384_792, "", "sum of " + _MEMO_DR_FILE + " M5 channels TWA 12m+7m")},
                 "max":    {"datarate": _r(3.533, "GB/s", "sum of " + _MEMO_DR_FILE + " M5 max 12m+7m"),
                            "nchan_agg": _r(2_370_368, "", "sum of " + _MEMO_DR_FILE + " M5 channels max 12m+7m")}},
    },
}
...
MEMO_DATAVOL_TABLE: Dict[str, Dict[str, Dict[str, Dict[str, RefValue]]]] = {
        ...
        "7m":   {"median":          {"datavol_total": _r(0.003, "TB", _MEMO_DV_FILE + " M1 total median 7m",
                 ...
                 "total_per_cycle": {"datavol_total": _r(0.017, "PB", _MEMO_DV_FILE + " M1 total per cycle 7m",
                                     ...
                                     "productsize": _r(0.018, "PB", _MEMO_DV_FILE + " M1 prod per cycle 7m",
                                                       rel_tol=0.1)}},
        # "both" = sum(12m, 7m) per-stat.  total_per_cycle cells are the
        # memo's own summed values (unchanged).
        "both": {"median":          {"datavol_total": _r(0.072, "TB", "sum of " + _MEMO_DV_FILE + " M1 total median 12m+7m"),
                                     "datavol_science": _r(0.047, "TB", "sum of " + _MEMO_DV_FILE + " M1 sci median 12m+7m"),
                                     "productsize": _r(0.044, "TB", "sum of " + _MEMO_DV_FILE + " M1 prod median 12m+7m")},
                 "twa":             {"datavol_total": _r(0.845, "TB", "sum of " + _MEMO_DV_FILE + " M1 total TWA 12m+7m"),
                                     "datavol_science": _r(0.626, "TB", "sum of " + _MEMO_DV_FILE + " M1 sci TWA 12m+7m"),
                                     "productsize": _r(3.824, "TB", "sum of " + _MEMO_DV_FILE + " M1 prod TWA 12m+7m")},
                 "max":             {"datavol_total": _r(14.378, "TB", "sum of " + _MEMO_DV_FILE + " M1 total max 12m+7m"),
                                     "datavol_science": _r(11.794, "TB", "sum of " + _MEMO_DV_FILE + " M1 sci max 12m+7m"),
                                     "productsize": _r(375.273, "TB", "sum of " + _MEMO_DV_FILE + " M1 prod max 12m+7m")},
        ...
        "7m":   {"median":          {"datavol_total": _r(0.003, "TB", _MEMO_DV_FILE + " M4 total median 7m",
                 ...
                 "total_per_cycle": {"datavol_total": _r(0.031, "PB", _MEMO_DV_FILE + " M4 total per cycle 7m",
                                     ...
                                     "productsize": _r(0.026, "PB", _MEMO_DV_FILE + " M4 prod per cycle 7m",
                                                       rel_tol=0.1)}},
        "both": {"median":          {"datavol_total": _r(0.138, "TB", "sum of " + _MEMO_DV_FILE + " M4 total median 12m+7m"),
                                     "datavol_science": _r(0.090, "TB", "sum of " + _MEMO_DV_FILE + " M4 sci median 12m+7m"),
                                     "productsize": _r(0.046, "TB", "sum of " + _MEMO_DV_FILE + " M4 prod median 12m+7m")},
                 "twa":             {"datavol_total": _r(3.073, "TB", "sum of " + _MEMO_DV_FILE + " M4 total TWA 12m+7m"),
                                     "datavol_science": _r(2.326, "TB", "sum of " + _MEMO_DV_FILE + " M4 sci TWA 12m+7m"),
                                     "productsize": _r(4.383, "TB", "sum of " + _MEMO_DV_FILE + " M4 prod TWA 12m+7m")},
                 "max":             {"datavol_total": _r(92.196, "TB", "sum of " + _MEMO_DV_FILE + " M4 total max 12m+7m"),
                                     "datavol_science": _r(77.462, "TB", "sum of " + _MEMO_DV_FILE + " M4 sci max 12m+7m"),
                                     "productsize": _r(344.184, "TB", "sum of " + _MEMO_DV_FILE + " M4 prod max 12m+7m")},
    ...
    "M5": {
        ...
        "both": {"median":          {"datavol_total": _r(0.318, "TB", "sum of " + _MEMO_DV_FILE + " M5 total median 12m+7m"),
                                     "datavol_science": _r(0.206, "TB", "sum of " + _MEMO_DV_FILE + " M5 sci median 12m+7m"),
                                     "productsize": _r(0.105, "TB", "sum of " + _MEMO_DV_FILE + " M5 prod median 12m+7m")},
                 "twa":             {"datavol_total": _r(7.374, "TB", "sum of " + _MEMO_DV_FILE + " M5 total TWA 12m+7m"),
                                     "datavol_science": _r(5.384, "TB", "sum of " + _MEMO_DV_FILE + " M5 sci TWA 12m+7m"),
                                     "productsize": _r(11.185, "TB", "sum of " + _MEMO_DV_FILE + " M5 prod TWA 12m+7m")},
                 "max":             {"datavol_total": _r(166.912, "TB", "sum of " + _MEMO_DV_FILE + " M5 total max 12m+7m"),
                                     "datavol_science": _r(138.390, "TB", "sum of " + _MEMO_DV_FILE + " M5 sci max 12m+7m"),
                                     "productsize": _r(1001.273, "TB", "sum of " + _MEMO_DV_FILE + " M5 prod max 12m+7m")},
        ...
        "7m":   {"median": {"visrate": _r(1.6, "Gvis/hr", _MEMO_SP_FILE + " M1 visrate median 7m"),
                 ...
                 "max":    {"visrate": _r(9.6, "Gvis/hr", _MEMO_SP_FILE + " M1 visrate max 7m"),
                            "sysperf": _r(0.012, "PFLOP/s", _MEMO_SP_FILE + " M1 sysperf max 7m",
                                          rel_tol=0.1)}},
        # "both" = sum(12m, 7m) per-stat.
        "both": {"median": {"visrate": _r(43.3, "Gvis/hr", "sum of " + _MEMO_SP_FILE + " M1 visrate median 12m+7m"),
                            "sysperf": _r(0.012, "PFLOP/s", "sum of " + _MEMO_SP_FILE + " M1 sysperf median 12m+7m",
                                          rel_tol=0.2, abs_tol=5e-4)},
                 "twa":    {"visrate": _r(102.8, "Gvis/hr", "sum of " + _MEMO_SP_FILE + " M1 visrate TWA 12m+7m"),
                            "sysperf": _r(0.045, "PFLOP/s", "sum of " + _MEMO_SP_FILE + " M1 sysperf TWA 12m+7m")},
                 "max":    {"visrate": _r(384.9, "Gvis/hr", "sum of " + _MEMO_SP_FILE + " M1 visrate max 12m+7m"),
                            "sysperf": _r(0.479, "PFLOP/s", "sum of " + _MEMO_SP_FILE + " M1 sysperf max 12m+7m")}},
    },
    "M4": {
        ...
        "both": {"median": {"visrate": _r(88.8, "Gvis/hr", "sum of " + _MEMO_SP_FILE + " M4 visrate median 12m+7m"),
                            "sysperf": _r(0.024, "PFLOP/s", "sum of " + _MEMO_SP_FILE + " M4 sysperf median 12m+7m")},
                 "twa":    {"visrate": _r(346.0, "Gvis/hr", "sum of " + _MEMO_SP_FILE + " M4 visrate TWA 12m+7m"),
                            "sysperf": _r(0.176, "PFLOP/s", "sum of " + _MEMO_SP_FILE + " M4 sysperf TWA 12m+7m")},
                 "max":    {"visrate": _r(3041.3, "Gvis/hr", "sum of " + _MEMO_SP_FILE + " M4 visrate max 12m+7m"),
                            "sysperf": _r(3.788, "PFLOP/s", "sum of " + _MEMO_SP_FILE + " M4 sysperf max 12m+7m")}},
    },
    "M5": {
        ...
        "both": {"median": {"visrate": _r(212.2, "Gvis/hr", "sum of " + _MEMO_SP_FILE + " M5 visrate median 12m+7m"),
                            "sysperf": _r(0.049, "PFLOP/s", "sum of " + _MEMO_SP_FILE + " M5 sysperf median 12m+7m",
                                          rel_tol=0.1)},
                 "twa":    {"visrate": _r(840.0, "Gvis/hr", "sum of " + _MEMO_SP_FILE + " M5 visrate TWA 12m+7m"),
                            "sysperf": _r(0.386, "PFLOP/s", "sum of " + _MEMO_SP_FILE + " M5 sysperf TWA 12m+7m")},
                 "max":    {"visrate": _r(6082.4, "Gvis/hr", "sum of " + _MEMO_SP_FILE + " M5 visrate max 12m+7m"),
                            "sysperf": _r(7.576, "PFLOP/s", "sum of " + _MEMO_SP_FILE + " M5 sysperf max 12m+7m")}},
    },
}
